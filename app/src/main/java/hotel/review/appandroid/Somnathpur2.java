...
public class Somnathpur2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_somnathpur2);
        ...
        roadmap_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                Intent palace=new Intent(Somnathpur2.this,Map.class);
                palace.putExtra("V",12.275981511194612);
                palace.putExtra("V1",76.88218489659093);
        ...
        header_background.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                if(flag)
                {
                    header_background.setImageResource(R.drawable.chennakesava);
                    flag=false;
                }
                else{
                    header_background.setImageResource(R.drawable.chennakesava);
        ...
        down_arrow.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Somnathpur2.this, Somnathpur.class);

                Pair[] pairs = new Pair[1];
                pairs[0] = new Pair<View, String>(down_arrow, "background_image_transition");

                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(Somnathpur2.this, pairs);
