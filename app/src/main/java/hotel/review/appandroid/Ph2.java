    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roadmap_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                Intent palace=new Intent(Ph2.this,Map.class);
                palace.putExtra("V",12.32130373419195);
                palace.putExtra("V1",76.65823131008405);
        ...
        header_background.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                if(flag)
                {
                    header_background.setImageResource(R.drawable.ph);
                    flag=false;
                }
                else{
                    header_background.setImageResource(R.drawable.philomenas);
                    flag=true;
                }
            }
        });
        ...
        down_arrow.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Ph2.this, Philomenas.class);

                Pair[] pairs = new Pair[1];
                pairs[0] = new Pair<View, String>(down_arrow, "background_image_transition");

                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(Ph2.this, pairs);
