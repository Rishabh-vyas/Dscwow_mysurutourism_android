    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roadmap_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                Intent palace=new Intent(Dam2.this,Map.class);
                palace.putExtra("V",12.42573822936184);
                palace.putExtra("V1",76.57241663892131);
        ...
        header_background.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                if(flag)
                {
                    header_background.setImageResource(R.drawable.dam);
                    flag=false;
                }
                else{
                    header_background.setImageResource(R.drawable.dam);
        ...
        down_arrow.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Dam2.this, Dam.class);

                Pair[] pairs = new Pair[1];
                pairs[0] = new Pair<View, String>(down_arrow, "background_image_transition");

                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(Dam2.this, pairs);
