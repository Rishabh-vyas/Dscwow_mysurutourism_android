...
public class Infosys2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infosys2);
        ...
        roadmap_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                Intent palace=new Intent(Infosys2.this,Map.class);
                palace.putExtra("V",12.366365651402926);
                palace.putExtra("V1",76.59664183659498);
        ...
        header_background.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                if(flag)
                {
                    header_background.setImageResource(R.drawable.infosys);
                    flag=false;
                }
                else{
                    header_background.setImageResource(R.drawable.in);
                    flag=true;
                }
            }
        });
        ...
        down_arrow.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Infosys2.this, Infosys.class);

                Pair[] pairs = new Pair[1];
                pairs[0] = new Pair<View, String>(down_arrow, "background_image_transition");

                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(Infosys2.this, pairs);
