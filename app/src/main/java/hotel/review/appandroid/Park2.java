    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roadmap_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                Intent palace=new Intent(Park2.this,Map.class);
                palace.putExtra("V",12.353384421644549);
                palace.putExtra("V1",76.63459343892035);
        ...
        header_background.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                if(flag)
                {
                    header_background.setImageResource(R.drawable.fantasy);
                    flag=false;
                }
                else{
                    header_background.setImageResource(R.drawable.fantasy);
        ...
        down_arrow.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Park2.this, Park.class);

                Pair[] pairs = new Pair[1];
                pairs[0] = new Pair<View, String>(down_arrow, "background_image_transition");

                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(Park2.this, pairs);
